...
if decision1 == "1":
    ...
    print(colors("\n    O arquivo deve estar neste diretório e se chamar, respectivamente, \"linux.txt\" ou \"windows.txt\"", "yellow","false"))
...
if decision1 == "2":
    ...
    print(colors("\n    O arquivo remove.txt deve estar neste diretório e conter apenas um hostname por linha.", "yellow","false"))
    print(colors("\n    Digite o IP do host a ser removido, \"f\" para remover todos os hosts incluidos em remove.txt.", "red","false"))
    ip = input("    ")
    if ip == "f":
